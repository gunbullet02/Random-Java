...
public class FinalPayrollSystem extends javax.swing.JFrame{
    
    public FinalPayrollSystem() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jEmployeeLabel1 = new javax.swing.JLabel();
        jDepartmentLabel2 = new javax.swing.JLabel();
        jRateLabel3 = new javax.swing.JLabel();
        jIDLabel4 = new javax.swing.JLabel();
        jDaysLabel5 = new javax.swing.JLabel();
        ...
        jGrossSalaryLabel6 = new javax.swing.JLabel();
        ...
        jEmployeeLabel1.setFont(new java.awt.Font("Century Gothic", 1, 12)); 
        jEmployeeLabel1.setText("Employees Name:");

        jDepartmentLabel2.setFont(new java.awt.Font("Century Gothic", 1, 12)); 
        jDepartmentLabel2.setText("Department:");

        jRateLabel3.setFont(new java.awt.Font("Century Gothic", 1, 12));
        jRateLabel3.setText("Rate Per Day:");

        jIDLabel4.setFont(new java.awt.Font("Century Gothic", 1, 12));
        jIDLabel4.setText("ID Number:");

        jDaysLabel5.setFont(new java.awt.Font("Century Gothic", 1, 12)); 
        jDaysLabel5.setText("Number of Day's Worked:");

        id_number.setToolTipText("");

        jGrossSalaryLabel6.setFont(new java.awt.Font("Century Gothic", 1, 12));
        jGrossSalaryLabel6.setText("Gross Salary:");

        compute.setFont(new java.awt.Font("Century Gothic", 1, 14)); 
        ...
        clear.setFont(new java.awt.Font("Century Gothic", 1, 14)); 
        clear.setText("Clear");
        ...
        quit.setFont(new java.awt.Font("Century Gothic", 1, 14)); 
        ...
        about.setFont(new java.awt.Font("Century Gothic", 1, 14)); 
        about.setText("About");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(jDaysLabel5)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(days_work, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jEmployeeLabel1)
                                    .addComponent(jDepartmentLabel2)
                                    .addComponent(jIDLabel4)
                                    .addComponent(jRateLabel3))
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(52, 52, 52)
                            ...
                            .addComponent(jGrossSalaryLabel6)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(18, 18, 18)
        ...
        jEmployeeLabel1.getAccessibleContext().setAccessibleName("");
        days_work.getAccessibleContext().setAccessibleName("");
        jGrossSalaryLabel6.getAccessibleContext().setAccessibleName("");
    ...
    int confirmed = JOptionPane.showConfirmDialog(null,"Simple","Simple Payroll",JOptionPane.OK_OPTION);
    ...
    private javax.swing.JLabel jEmployeeLabel1;
    private javax.swing.JLabel jDepartmentLabel2;
    private javax.swing.JLabel jRateLabel3;
    private javax.swing.JLabel jIDLabel4;
    private javax.swing.JLabel jDaysLabel5;
    private javax.swing.JLabel jGrossSalaryLabel6;
